...
export default function Task({task, handleDeletePopup, handleDetailsPopup, isAllChecked}: any) {
    ...
    useEffect(()=>{
        let elem1: any =  document.getElementsByName('997')[0]
        elem1.getAttribute('checked', 'checked');
    }, [isAllChecked])
    function handleEdit(elemId: any) {
        setPopup(true)
...
function handleChecked(task: any) {
...
function setUncompletedTask(task: any) {
    let uncompletedTask = {
        ...task,
